...
{
      $id=intval($_GET['del']);
      $adn="delete from albosets_train where id=?";
                ...
                <div class="card-body">
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <?php
                        ...
                        */
                        $ret="SELECT * FROM `albosets_passwordresets` where status ='Approved'  "; //sql code to get all details of psssword reset requests.
